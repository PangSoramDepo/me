                ...
                <div class="container">
					<div class="header-content-bx no-bdr">
						...
						<div class="logo-header">
							<a href="index.html"><img src="{{url('assets/images/name_logo_black.png')}}" alt=""/></a>
						</div>
						<!-- nav toggle button -->
						...
						<div class="header-nav navbar-collapse collapse justify-content-center" id="navbarNavDropdown">
							<div class="logo-header">
								<a href="index.html"><img src="{{url('assets/images/name_logo_white.png')}}" alt=""/></a>
							</div>
							<ul class="nav navbar-nav">
								...
								<li>
									<a href="#">Post Layout <i class="fa fa-chevron-down"></i></a>
									<ul class="sub-menu">
												...
												<div id="all" class="life-style-post-bx show">
													<div class="header-blog-carousel owl-carousel owl-btn-center-lr">
														<div class="item">
															<div class="blog-post blog-sm">
																<div class="dlab-post-media">
																	<a href="post-standart.html"><img src="{{url('assets/images/d5.jpg')}}" alt=""></a>
																</div>
																<div class="dlab-post-info">
																	<div class="dlab-post-title ">
																		<h5 class="post-title"><a href="post-standart.html">Cobalt Leather</a></h5>
																	</div>
																	<div class="date">
																		25 January, 2020
																	</div>
														...
														<div class="item">
															<div class="blog-post blog-sm">
																<div class="dlab-post-media">
																	<a href="post-left-sidebar.html"><img src="{{url('assets/images/d5.jpg')}}" alt=""></a>
																</div>
																<div class="dlab-post-info">
																	<div class="dlab-post-title ">
																		<h5 class="post-title"><a href="post-left-sidebar.html">Styling Harvey</a></h5>
																	</div>
																	<div class="date">
																		25 January, 2020
																	</div>
														...
														<div class="item">
															<div class="blog-post blog-sm">
																<div class="dlab-post-media">
																	<a href="post-full-width.html"><img src="{{url('assets/images/d5.jpg')}}" alt=""></a>
																</div>
																<div class="dlab-post-info">
																	<div class="dlab-post-title ">
																		<h5 class="post-title"><a href="post-full-width.html">Denim for Spring</a></h5>
																	</div>
																	<div class="date">
																		25 January, 2020
																	</div>
														...
														<div class="item">
															<div class="blog-post blog-sm">
																<div class="dlab-post-media">
																	<a href="post-slide-show.html"><img src="{{url('assets/images/d5.jpg')}}" alt=""></a>
																</div>
																<div class="dlab-post-info">
																	<div class="dlab-post-title ">
																		<h5 class="post-title"><a href="post-slide-show.html">Clarins Mascara</a></h5>
																	</div>
																	<div class="date">
																		25 January, 2020
																	</div>
													...
													<div class="header-blog-carousel owl-carousel owl-btn-center-lr">
														...
														<div class="item">
															<div class="blog-post blog-sm">
																...
																<div class="dlab-post-info">
																	<div class="dlab-post-title ">
																		<h5 class="post-title"><a href="post-full-width.html">Dress Like a Parisian</a></h5>
																	</div>
																	<div class="date">
																		25 January, 2020
																	</div>
							...
							<div class="side-bar p-l30 sticky-top">
								...
								<div class="widget widget-social">
									...
									<div class="advertise text-center m-b20">
										<img src="{{url('assets/images/ads.png')}}" alt=""/>
									</div>
									<div class="fb-social relative">
										<img src="{{url('assets/images/back_group2.jpg')}}" alt=""/>
